...
import jlll.common.Procedure;
import jlll.common.ReflectionPrimitive;
import jlll.common.Symbol;
import jlll.common.annotation.JlllName;
import jlll.io.Marshaller;
...
public class JLLLTestCase
{
    ...
    public void testCons() throws Exception
    {
    	...
    	assertEquals(new Cons(Symbol.intern("a"), new Cons(Symbol.intern("b"))), ListUtil.toCons(Symbol.intern("a"), Symbol.intern("b")));
    ...
    {
        String[] commands = new String[]{"()" ,"(1 () 2)",
        								"a","(a)","(a b)",
                                        "(a . b)","(\"string\")","(\"string\" . \"string2\")",
...
//        eval("#f", new Boolean(false));
    ...
    {
        eval(new Cons(Symbol.intern("a"),Symbol.intern("b")), "(new 'jlll.common.Cons 'a 'b)");
        eval(Symbol.intern("b"), "(invoke '(a b c) 'get 1)");
        eval(Symbol.intern("a"), "(invoke-static 'jlll.common.Symbol 'intern \"a\")");
        eval(1, "(peek (new 'jlll.tests.JLLLTestCase$ReflectionClass) 'fieldA)");
        eval(1, "(peek-static 'jlll.tests.JLLLTestCase$ReflectionClass 'fieldStaticA)");
        eval(2,"(define o (new 'jlll.tests.JLLLTestCase$ReflectionClass)) " +
				        "(poke o 'fieldA 2) (peek o 'fieldA)");
        eval(2,"(poke-static 'jlll.tests.JLLLTestCase$ReflectionClass 'fieldStaticA 2)" +
				        "(peek-static 'jlll.tests.JLLLTestCase$ReflectionClass 'fieldStaticA)");
        eval(true,"(instanceof? '(a b) 'jlll.common.Cons)");
    ...
    {        
        Object[] tests = new Object[]{"test",
                                      new BigInteger("1"),
                                      Symbol.intern("symbol"),
                                      new Cons(Symbol.intern("cons")),
                                      new Cons(Symbol.intern("sym1"),Symbol.intern("sym2")),
                                      Null.NULL};
    ...
    public void testReflectPrimitives() throws Exception
    {
        ...
        assertEquals(((Primitive)env.lookup("new")).applayEvaluated(env,Cons.class, Symbol.intern("a"),Symbol.intern("b"))
